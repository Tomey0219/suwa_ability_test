...
use App\Http\Controllers\ConfirmedTwoFactorAuthenticationController;
...
use App\Http\Controllers\TwoFactorSecretKeyController;
...
Route::get('/', [ContactController::class, 'contact_disp']);

Route::post('/confirm', [ContactController::class, 'confirm']);

Route::post('/correct', [ContactController::class, 'correct']);

Route::post('/reg_contact_form', [ContactController::class, 'reg_db']);
...
Route::middleware('auth')->group(function () {
    Route::post('/admin', [ContactController::class, 'admin_disp']);
});
